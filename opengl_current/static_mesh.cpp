    ...
    m_VertexArray{std::make_shared<VertexArray>()}
{
    ...
    m_VertexArray->AddVertexBuffer(std::make_shared<VertexBuffer>(Vertices.data(), (std::int32_t)Vertices.size() * sizeof(StaticMeshVertex)), StaticMeshVertex::DataFormat);
